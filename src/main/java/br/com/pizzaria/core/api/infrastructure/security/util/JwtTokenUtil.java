package br.com.pizzaria.core.api.infrastructure.security.util;
...
import br.com.pizzaria.core.api.application.configuration.ApplicationProperty.JwtTokenConfig;
import br.com.pizzaria.core.api.infrastructure.security.auth.UsuarioAuth;
...
public class JwtTokenUtil {
    ...
    public Long getId(String token) {
        Long id;
        try {
            id = Long.parseLong(getClaims(token).get(CLAIM_ID).toString());
    ...
    private JwtTokenConfig getJwtTokenConfig() {
